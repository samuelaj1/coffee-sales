    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="mb-3">
                ...
                <input type="number" id="quantity" class="form-control" v-model.number="quantity" placeholder="quantity">
            </div>
        </div>
        <div class="col-md-3">
            <div class="mb-3">
                <label for="unit_cost">Unit Cost (£):</label>
                <input type="number" id="unit_cost" class="form-control" v-model.number="unitCost" placeholder="Unit cost">
            </div>
        </div>
        <div class="col-md-3">
            <div class="mb-3">
